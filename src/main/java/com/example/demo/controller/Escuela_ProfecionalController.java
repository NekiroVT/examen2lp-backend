...
public class Escuela_ProfecionalController {
    ...
    public ResponseEntity<Escuela_Profecional> getEscuela_ProfecionalById(@PathVariable("id") int id){
        ...
        return carData.map(escuela_Profecional -> new ResponseEntity<>(escuela_Profecional, HttpStatus.OK))
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @Valid @RequestBody Escuela_ProfecionalDto escuelaDto) {
        try {
            Escuela_Profecional updatedEscuela = escuela_ProfecionalServiceImpl.update(id, escuelaDto);
